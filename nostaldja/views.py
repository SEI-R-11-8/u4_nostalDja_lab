...
def decade_info(request):
    decades = Decade.objects.all()
    return render(request, 'nostaldja/decade_info.html', {'decades': decades})

def fad_info(request):
    fads = Fad.objects.all()
    return render(request, 'nostaldja/fad_info.html', {'fads': fads})
